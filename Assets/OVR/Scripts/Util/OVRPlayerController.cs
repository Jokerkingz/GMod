...
public class OVRPlayerController : MonoBehaviour
{
	...
	public float buttonRotation = 0f;
	...
	public virtual void UpdateMovementOriginal()
	{	if (vSkipMovement)
			return;
	...
	public void UpdateTransform(OVRCameraRig rig)
	{
		...
		if (HmdRotatesY)
		{
			...
			/*
			float tTemp = vAngleOffSet;//centerEye.rotation.eulerAngles.y+vAngleOffSet;
			...
			transform.rotation = Quaternion.Euler(0.0f,tTemp, 0.0f);
			*/
